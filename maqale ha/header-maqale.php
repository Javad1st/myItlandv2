      ...
      <div class="hamburger-menu">
        <div class="hamburger-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
          ...
          <div class="menu-item">
            ...
            <div class="dropdown-content">
              <a href="../undeveloped.html">تلگرام</a>
...
input.value = "";
        ...
        <div id="aboutDropdown" class="dropdownContent">
          <a href="../undeveloped.html" class="dropdownItem">تاریخچه</a>
          <a href="../undeveloped.html" class="dropdownItem">کامینیتی</a>
          <a href="../undeveloped.html" class="dropdownItem">سازندگان</a>
        </div>
        </div>
        
        <!-- Support Dropdown -->
        <div class="headerButton headerButton2"><a href="../ai.php"><p>هوش مصنوعی </p></a> </div>
        ...
        <div id="homeDropdown" class="dropdownContent dropdownContent1">
          ...
          <a href="../undeveloped.html" class="dropdownItem dropdownItem2"><svg xmlns="http://www.w3.org/2000/svg" width="24"
            height="24" viewBox="0 0 24 20" style="fill: var(--zed);">
            <path
                d="M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM9 9H5V5h4v4zm11-6h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zm-1 6h-4V5h4v4zm-9 4H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1zm-1 6H5v-4h4v4zm8-6c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 6c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z">
              </path>
            </svg>دسته بندی ها</a>
            <a href="../undeveloped.html" class="dropdownItem dropdownItem3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" viewBox="0 0 24 24" style="fill: var(--zed);">
              <path
          ...
          <a href="#" class="dropdownItem dropdownItem4"><svg xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" viewBox="0 0 24 24" style="fill: var(--zed);">
              <path
          ...
          <a href="../undeveloped.html" class="dropdownItem dropdownItem5"><svg xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" viewBox="0 0 24 24" style="fill: var(--zed);">
              <path

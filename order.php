        ...
        <div class="form-container">
            ...
            <div class="step-container">
                <div class="step active-step" id="step1"> 1
                    ...
                    <img id="cable1" class="rotCable cable" src="tasavir/cable.png" alt="" width="160px">
                </div>
                ...
                <img id="cable2" class="cable " src="tasavir/cable.png" alt="" width="160px">
                ...
                <img id="cable3" class="rotCable cable" src="tasavir/cable.png" alt="" width="160px">
